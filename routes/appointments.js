...
// TODO: move to the admin or keep remain as /appointments

// Get all pending appointments of the specific patient  for admin approval
// TODO: need to move to inside the admin methods to create Protected Admin Route. fixed: have already fixed by removing hn_number from this method
...
// Count endpoints
// TODO: need to move to inside the admin methods to create Protected Admin Route.
const countRoutes = [
  {
    path: "/pending/count",
    status: "pending",
...
// The specific doctor's available slots of the specific appointment for the admin to reschedule the time
// TODO: need to move to inside the admin methods to create Protected Admin Route.
...
// Utility function
// TODO: need to move to inside the admin methods to create Protected Admin Route. OR create as a middleware
